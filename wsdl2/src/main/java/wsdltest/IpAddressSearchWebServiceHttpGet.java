...
public interface IpAddressSearchWebServiceHttpGet {
    ...
    public ArrayOfString getCountryCityByIp(
        ...
        @WebParam(partName = "theIpAddress", name = "theIpAddress", targetNamespace = "http://WebXml.com.cn/")
                GetCountryCityByIp theIpAddress
    );
    ...
    @WebResult(name = "getGeoIPContextResponse", targetNamespace = "http://WebXml.com.cn/", partName = "Body")
...
;
    ...
    @WebResult(name = "getVersionTimeResponse", targetNamespace = "http://WebXml.com.cn/", partName = "Body")
